...
@php
    $classes = ($active ?? false)
                ? 'inline-flex items-center px-1 pt-1 border-b-2 border-orange-500 dark:border-orange-600 text-sm font-medium leading-5 text-black focus:outline-none focus:border-orange-700 transition duration-150 ease-in-out'
