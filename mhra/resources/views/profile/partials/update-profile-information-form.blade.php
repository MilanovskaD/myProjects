<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
        ...
        <div>
            ...
            <textarea id="bio" name="bio" class="mt-1 block w-full bg-gray-700 text-white border-gray-300 rounded-md focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50" rows="4">{{ old('bio', $user->bio) }}</textarea>
        ...
        <!-- Upload CV -->
        <div>
            <x-input-label for="cv_upload_path" :value="__('Upload CV')" />
        ...
        <!-- Upload Photo -->
        <div>
            <x-input-label for="photo_upload_path" :value="__('Upload Photo')" />
