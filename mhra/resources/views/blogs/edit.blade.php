<x-app-layout>
    <h2 class="my-4 text-xl font-bold text-gray-900 text-center">Edit Blog</h2>
    <br/>
                ...
                @endif
                    ...
                    <div class="mt-6">
                        ...
                        <textarea name="body" id="body"
                                  class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5">{{ old('body', $blog->body) }}</textarea>
                    </div>
                    <button type="submit"
